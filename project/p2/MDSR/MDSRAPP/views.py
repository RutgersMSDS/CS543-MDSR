...
def searchbar(request):
    if request.method == "GET":
        ...
        return render(request, 'MDSRAPP/searchbar.html', {"search": search})

def searchbar2(request):
    if request.method == "GET":
        search2 = request.GET.get('search2')
        return render(request, 'MDSRAPP/searchbar2.html', {"search2": search2})
...
def generalN(request):
    return render(request, 'MDSRAPP/generalN.html')
